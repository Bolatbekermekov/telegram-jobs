...
_SYSTEM = (
    ...
    "ФОРМАТ: 'Мой стек: [ровно до 7 технологий].' Потом новое предложение: "
    "'Плюс к пониманию системы целиком: [до 4 бэкенд-технологий].' Если в вакансии названы инструменты (Postman, "
