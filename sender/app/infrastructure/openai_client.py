...
_SYSTEM = (
    ...
    "Если в тексте вакансии нет конкретики о компании, вставь РОВНО плейсхолдер в квадратных "
    "скобках: [здесь 1-2 предложения: почему именно эта компания, заполнить вручную]. "
