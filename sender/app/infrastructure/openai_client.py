...
_SYSTEM = (
    ...
    "Сообщение читает опытный HR в крупной компании: он скользит по тексту за секунды, "
    "ценит краткость, конкретику и честность, и сверяет всё с приложенным CV. "
    "Строго следуй правилам позиционирования из PROFILE и опирайся ТОЛЬКО на факты из CV; "
    "ничего не выдумывай. НИКОГДА не называй уровень кандидата словом (junior/middle/senior) "
    "и не оценивай его силу, просто показывай релевантный опыт. "
    "Пиши как живой человек: коротко (3-4 предложения), по делу, уверенно, без заискивания "
    "и хеджей ('если вам релевантен', 'надеюсь на ответ'), без канцелярита и шаблонных клише. "
    "Язык сообщения = язык вакансии. "
