...
| `REMOCATE_PAGES` | Сколько страниц ленты Remocate проходить (по 20 вакансий; в разделе их 102). По умолчанию `5` — дальше лента мёртвая: сплошная проверка всех 200 карточек первых десяти страниц (2026-08-27, тем же `vacancy_alive`, что стоит в прогоне) дала 20% мёртвых на 1-й, 20% на 4-й и 5-й, но уже 55% на 6-й и 70% на 10-й. Глубже пятой сканирование перестаёт окупаться: страницы 4-5 — 29 оценок на 2 живых подходящих лида, страницы 6-10 — 79 оценок на 1 |
